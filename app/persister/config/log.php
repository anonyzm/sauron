...
if (getenv('SENTRY_ENABLED') == 'true') {
    ...
    $targets = [
        'error' => [
            ...
            'levels' => ['error', 'warning'],
            'logFile' => '@persister/runtime/logs/error.log',
        ...
        'profile' => [
            'class' => 'yii\log\FileTarget',
            'levels' => ['profile'],
            'logFile' => '@persister/runtime/logs/profile.log',
            'logVars' => ['_SERVER.USER', '_SERVER.SCRIPT_NAME', '_SERVER.argv'],
            'exportInterval' => 1,
        ],
        'app' => [
            ...
            'levels' => ['info'],
            'logFile' => '@persister/runtime/logs/app.log',
            'logVars' => [],
            'exportInterval' => 1,
        ],
        [
            'class' => 'yii\log\FileTarget',
            'levels' => ['profile'],
            'logFile' => '@persister/runtime/logs/http-request.log',
    ...
    $targets['woody'] = [
        ...
        'levels' => ['trace'],
        'categories' => ['woody'],
        'logFile' => '@persister/runtime/logs/woody.log',
        'logVars' => [],
        'exportInterval' => 1,
    ];
