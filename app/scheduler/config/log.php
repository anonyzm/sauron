...
if (getenv('SENTRY_ENABLED') == 'true') {
    ...
    $targets = [
        'error' => [
            ...
            'levels' => ['error', 'warning'],
            'logFile' => '@scheduler/runtime/logs/error.log',
        ...
        'profile' => [
            'class' => 'yii\log\FileTarget',
            'levels' => ['profile'],
            'logFile' => '@scheduler/runtime/logs/profile.log',
            'logVars' => ['_SERVER.USER', '_SERVER.SCRIPT_NAME', '_SERVER.argv'],
            'exportInterval' => 1,
        ],
        'app' => [
            ...
            'levels' => ['info'],
            'logFile' => '@scheduler/runtime/logs/app.log',
            'logVars' => [],
            'exportInterval' => 1,
        ],
        [
            'class' => 'yii\log\FileTarget',
            'levels' => ['profile'],
            'logFile' => '@scheduler/runtime/logs/http-request.log',
    ...
    $targets['woody'] = [
        ...
        'levels' => ['trace'],
        'categories' => ['woody'],
        'logFile' => '@scheduler/runtime/logs/woody.log',
        'logVars' => [],
        'exportInterval' => 1,
    ];
}
